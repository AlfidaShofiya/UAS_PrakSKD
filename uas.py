...
#berfungsi untuk mengambil nilai kunci 
def getKey(keysize):
...
def encrypt_image(filename, key, iv):
    ...
    with open(filename, "rb") as file1: #berfungsi untuk membuka gambar
        data = file1.read()
...
# tahap dekripsi sama seperti enkripsi namun berbeda di proses dekripsi dari file gambar tersebut
...
KEYSIZE = 16 # kunci yang digunakan
BLOCKSIZE = 16 # panjang blok 
filename = "chanyeol.jpg" #file foto yang ingin di enkripsi atau deskripsi
